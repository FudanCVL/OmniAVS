...
if model.config.use_backbone_lora:
    model.vision_model.encoder.merge_and_unload()
    model.vision_model.encoder = model.vision_model.encoder.model
...
if model.config.use_audio_lora:
    model.audio_model.merge_and_unload()
    model.audio_model = model.audio_model.model
    model.config.use_audio_lora = 0
