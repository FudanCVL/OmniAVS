...
def load_grefcoco_json(
    ...
    from internvl.train.my_utils.grefer import G_REFER
...
if __name__ == "__main__":
    ...
    REFCOCO_PATH = "data/segmentation/lisa_data/refer_seg"
    COCO_TRAIN_2014_IMAGE_ROOT = "data/segmentation/lisa_data/refer_seg/images/mscoco/train2014"
