...
from internvl.model.whisper.configuration_whisper import WhisperConfig
...
class InternVLChatConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        self.use_audio_lora = use_audio_lora
    ...
    def to_dict(self):
        ...
        output['use_audio_lora'] = self.use_audio_lora
        ...
        output['enable_mask'] = self.enable_mask
